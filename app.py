...
def admin_required(f):
    ...
    def decorated(*args, **kwargs):
        ...
        return f(*args, **kwargs)
    return decorated
DATABASE_URL = os.environ.get("DATABASE_URL", f"sqlite:///{os.path.join(BASE_DIR, 'recrut.db')}")
...
with app.app_context():
    ...
    if Offre.query.count() == 0:
        offres_data = [
            ...
            dict(id=2, titre="(02) Charge de Communication et Marketing Digital", poste="(02) Charge de Communication et Marketing Digital", nombre_postes=2, diplome_requis="Master en Communication, Marketing ou équivalent", experience_min=0, specialite="Communication", langues="Français, Arabe, Anglais", missions="Gérer les réseaux sociaux ; Produire les contenus digitaux ; Assurer la couverture médiatique des événements.", competences="Canva, WordPress, Pack Office, gestion de projets événementiels.", mots_cles="communication,marketing,digital,réseaux sociaux", date_limite="30/09/2026", actif=True),
            dict(id=3, titre="CGM", poste="CGM", nombre_postes=1, diplome_requis="Master", experience_min=2, specialite="Gestion", langues="Français, Arabe", missions="Gestion marchés ; Suivi administratif ; Contact prestataires.", competences="Maîtrise des démarches administratives ; Maitrise de l'exécution des différents travaux.", mots_cles="gestion,marchés,administratif", date_limite="30/09/2026", actif=True),
            dict(id=4, titre="(04) Assistant(e) Architecte", poste="Assistant Architecte", nombre_postes=1, diplome_requis="Licence en Architecture ou Technicien Spécialisé en Bâtiment/Dessin", experience_min=1, specialite="Architecture", langues="Français, Arabe", missions="Assister l'architecte responsable dans le suivi des projets ; Préparer et mettre à jour les plans et documents techniques (AutoCAD) ; Participer aux visites de chantier.", competences="Maîtrise AutoCAD ; Connaissance normes construction ; Lecture plans architecturaux.", mots_cles="architecte,assistant,autocad,dessin", date_limite="30/09/2026", actif=True),
        ]
    ...
    if Candidat.query.count() == 0:
        ...
        candidats_data = [
            dict(id=1,  nom="YOUSSEF",      prenom="Alami",     email="youssef.alami@gmail.com",           telephone="0661234567", poste="(01) Chef de projets Architecte", diplome="MASTER",              specialite="Gestion des entreprises",              ecole="ENCG",                                  promotion=2024, experience=9, score_ia=0.5382, decision="Présélectionné",  decision_manuelle=False, offre_id=1),
            dict(id=2,  nom="SARA",         prenom="Benali",    email="sara.benali@gmail.com",             telephone="0677890123", poste="(01) Chef de projets Architecte", diplome="MASTER",              specialite="Informatique",                         ecole="USMBA",                                 promotion=2024, experience=8, score_ia=0.6738, decision="Présélectionné",  decision_manuelle=False, offre_id=1),
            dict(id=3,  nom="KARIM",        prenom="Idrissi",   email="karim.idrissi@gmail.com",           telephone="0654321987", poste="(01) Chef de projets Architecte", diplome="TECHNICIEN SPECIALISE",specialite="Informatique",                         ecole="ISTA",                                  promotion=2024, experience=8, score_ia=0.3919, decision="Non retenu",     decision_manuelle=False, offre_id=1),
            dict(id=4,  nom="AMINE SAGHIRI",prenom="Mohammed",  email="saghiri.amine@gmail.com",           telephone="",           poste="(01) Chef de projets Architecte", diplome="LICENCE",             specialite="Générale",                             ecole="NEXA Digital School",                   promotion=2024, experience=0, score_ia=0.1745, decision="Non retenu",     decision_manuelle=False, offre_id=1),
            dict(id=5,  nom="BENALI",       prenom="Leila",     email="leila.benali@gmail.com",            telephone="0672345678", poste="CGM",                             diplome="MASTER",              specialite="Gestion des entreprises",              ecole="Autre",                                 promotion=2024, experience=4, score_ia=0.85,   decision="Présélectionné",  decision_manuelle=False, offre_id=3),
            dict(id=6,  nom="RACHIDI",      prenom="Omar",      email="omar.rachidi@gmail.com",            telephone="0683456789", poste="CGM",                             diplome="MASTER",              specialite="Finance",                              ecole="ENCG",                                  promotion=2024, experience=6, score_ia=0.85,   decision="Présélectionné",  decision_manuelle=False, offre_id=3),
            dict(id=7,  nom="TAZI",         prenom="Mehdi",     email="tazi.mehdi@gmail.com",              telephone="0661234567", poste="CGM",                             diplome="MASTER",              specialite="Finance",                              ecole="ENCG",                                  promotion=2024, experience=5, score_ia=0.85,   decision="Présélectionné",  decision_manuelle=False, offre_id=3),
            dict(id=8,  nom="BERRADA",      prenom="Younes",    email="younes.berrada.pro@gmail.com",      telephone="0661112233", poste="Assistant Architecte",            diplome="MASTER",              specialite="Génie Civil et Architecture",          ecole="École Hassania des Travaux Publics",     promotion=2020, experience=6, score_ia=0.3413, decision="Non retenu",     decision_manuelle=False, offre_id=4),
            dict(id=9,  nom="IDRISSI",      prenom="Salma",     email="salma.idrissi.cv@gmail.com",        telephone="0662223344", poste="Assistant Architecte",            diplome="TECHNICIEN SPECIALISE",specialite="Dessin de Bâtiment",                   ecole="ISTA Fès",                              promotion=2024, experience=1, score_ia=0.12,   decision="Non retenu",     decision_manuelle=False, offre_id=4),
            dict(id=10, nom="OUAZZANI",     prenom="Karim",     email="karim.ouazzani.pro@gmail.com",      telephone="0663334455", poste="Assistant Architecte",            diplome="MASTER",              specialite="Architecture et Urbanisme",            ecole="École Supérieure d'Architecture de Fès", promotion=2022, experience=2, score_ia=0.3359, decision="Non retenu",     decision_manuelle=False, offre_id=4),
            dict(id=11, nom="CHARKI",       prenom="Nadia",     email="nadia.charki.pro@gmail.com",        telephone="0664445566", poste="Assistant Architecte",            diplome="LICENCE",             specialite="Marketing et Commerce International",  ecole="ESTICE Business School",                promotion=2020, experience=5, score_ia=0.0975, decision="Non retenu",     decision_manuelle=False, offre_id=4),
            dict(id=12, nom="AMRANI",       prenom="Yassine",   email="yassine.amrani.cv@gmail.com",       telephone="0665556677", poste="Assistant Architecte",            diplome="BAC",                 specialite="Informatique et Intelligence Artificielle",ecole="Lycée Al Khawarizmi",                promotion=2023, experience=0, score_ia=0.1191, decision="Non retenu",     decision_manuelle=False, offre_id=4),
            dict(id=13, nom="ZIANI",        prenom="Imane",     email="imane.ziani.pro@gmail.com",         telephone="0666667788", poste="Assistant Architecte",            diplome="LICENCE",             specialite="Marketing, Communication et Événementiel",ecole="INSEEC",                              promotion=2025, experience=1, score_ia=0.1483, decision="Non retenu",     decision_manuelle=False, offre_id=4),
            dict(id=14, nom="BERRADA",      prenom="Younes",    email="younes.berrada2@gmail.com",         telephone="0661112233", poste="CGM",                             diplome="MASTER",              specialite="Génie Civil et Architecture",          ecole="École Hassania des Travaux Publics",     promotion=2020, experience=6, score_ia=0.8051, decision="Présélectionné",  decision_manuelle=False, offre_id=3),
            dict(id=15, nom="IDRISSI",      prenom="Salma",     email="salma.idrissi2@gmail.com",          telephone="0662223344", poste="CGM",                             diplome="TECHNICIEN SPECIALISE",specialite="Dessin de Bâtiment",                   ecole="ISTA Fès",                              promotion=2024, experience=1, score_ia=0.1924, decision="Non retenu",     decision_manuelle=False, offre_id=3),
            dict(id=16, nom="OUAZZANI",     prenom="Karim",     email="karim.ouazzani2@gmail.com",         telephone="0663334455", poste="CGM",                             diplome="MASTER",              specialite="Architecture et Urbanisme",            ecole="École Supérieure d'Architecture de Fès", promotion=2022, experience=4, score_ia=0.8259, decision="Présélectionné",  decision_manuelle=False, offre_id=3),
            dict(id=17, nom="CHARKI",       prenom="Nadia",     email="nadia.charki2@gmail.com",           telephone="0664445566", poste="CGM",                             diplome="LICENCE",             specialite="Marketing et Commerce International",  ecole="ESTICE Business School",                promotion=2020, experience=5, score_ia=0.3238, decision="Non retenu",     decision_manuelle=False, offre_id=3),
            dict(id=18, nom="AMRANI",       prenom="Yassine",   email="yassine.amrani2@gmail.com",         telephone="0665556677", poste="CGM",                             diplome="BAC",                 specialite="Informatique et Intelligence Artificielle",ecole="Lycée Al Khawarizmi",                promotion=2023, experience=1, score_ia=0.1832, decision="Non retenu",     decision_manuelle=False, offre_id=3),
            dict(id=19, nom="ZIANI",        prenom="Imane",     email="imane.ziani2@gmail.com",            telephone="0666667788", poste="CGM",                             diplome="LICENCE",             specialite="Marketing, Communication et Événementiel",ecole="INSEEC",                              promotion=2025, experience=3, score_ia=0.3251, decision="Non retenu",     decision_manuelle=False, offre_id=3),
            dict(id=20, nom="AMRANI",       prenom="Hind",      email="hind.amrani.pro@gmail.com",         telephone="0667778899", poste="CGM",                             diplome="LICENCE",             specialite="Architecture et Bâtiment",            ecole="ISTA",                                  promotion=2020, experience=4, score_ia=0.4628, decision="Présélectionné",  decision_manuelle=True,  offre_id=3),
        ]
        for c in candidats_data:
            db.session.add(Candidat(**c))
        db.session.commit()

    if EvaluationJury.query.count() == 0:
        evals_data = [
            dict(id=1, candidat_id=1, numero_jury=1, nom_jury="M. Hassan Alaoui",    poste_jury="Directeur RH",          note_presentation=14.0, note_motivation=13.0, note_competences=15.0, note_communication=12.0, note_culture=16.0, commentaire="", score_jury=14.0),
            dict(id=2, candidat_id=1, numero_jury=2, nom_jury="Mme. Fatima Bennani", poste_jury="Responsable Formation",  note_presentation=13.0, note_motivation=15.0, note_competences=12.0, note_communication=14.0, note_culture=13.0, commentaire="", score_jury=13.4),
            dict(id=3, candidat_id=1, numero_jury=3, nom_jury="M. Rachid Moussaoui", poste_jury="Chef de département",    note_presentation=12.0, note_motivation=14.0, note_competences=16.0, note_communication=13.0, note_culture=15.0, commentaire="", score_jury=14.0),
            dict(id=4, candidat_id=1, numero_jury=4, nom_jury="Mme. Amina Chaoui",   poste_jury="DG Adjoint",             note_presentation=15.0, note_motivation=16.0, note_competences=14.0, note_communication=15.0, note_culture=14.0, commentaire="", score_jury=14.8),
            dict(id=5, candidat_id=20, numero_jury=4, nom_jury="Fati RBIKI",          poste_jury="",                       note_presentation=10.0, note_motivation=10.0, note_competences=18.5, note_communication=10.0, note_culture=10.0, commentaire="", score_jury=11.7),
        ]
        for e in evals_data:
